!(function (e, t) {
        ...
        function (e) {
          ...
          return (
            e != k &&
              ...
              (p.getElementsByClassName = A.test(k.getElementsByClassName)),
              ...
              (i = []),
              (f = []),
              (p.qsa = A.test(k.querySelectorAll)) &&
                (N(function (e) {
                  var t;
              ...
              return (function e(h, f, m, g, v, t) {
                return (
                  ...
                  M(function (e, t, n, i) {
                    ...
                    } else (p = we(p === t ? p.splice(c, p.length) : p)), v ? v(null, t, p, i) : S.apply(t, p);
                  })
                );
              })(
                1 < s && be(d),
  ...
  var Le = /^(?:checkbox|radio)$/i,
    ...
    A =
      ((M = k.createElement("input")).setAttribute("type", "radio"),
          ...
          (u = h = (p = Se.exec(e[l]) || [])[1]),
            ...
            u &&
              ...
              (d = s[u]) ||
                ...
                c.setup && !1 !== c.setup.call(t, i, p, a)) ||
  ...
  function D(n, i, o, r) {
    ...
    var e,
      ...
      h = i[0],
      f = y(h);
    if (f || (1 < u && "string" == typeof h && !g.checkClone && Me.test(h)))
      return n.each(function (e) {
        var t = n.eq(e);
        f && (i[0] = h.call(this, e, t.html())), D(t, i, o, r);
      });
    if (
      u &&
  ...
  function ct(e, t, n, i, o, r) {
    ...
    for (; a < 4; a += 2)
      "margin" === n && (l += E.css(e, n + p[a], !0, o)),
        i
          ? ("content" === n && (l -= E.css(e, "padding" + p[a], !0, o)),
            "margin" !== n && (l -= E.css(e, "border" + p[a] + "Width", !0, o)))
          : ((l += E.css(e, "padding" + p[a], !0, o)),
            "padding" !== n
              ? (l += E.css(e, "border" + p[a] + "Width", !0, o))
              : (s += E.css(e, "border" + p[a] + "Width", !0, o)));
    return (
      !i &&
        0 <= r &&
        (l +=
  ...
  function N(o, e, t) {
    ...
    return (
      ...
      E.fx.timer(E.extend(h, { elem: o, anim: f, queue: f.opts.queue })),
      f
    );
  }
        ...
        if ((l = !E.isEmptyObject(t)) || !E.isEmptyObject(p))
          ...
          p))
            l ||
              ...
              f && S([e], !0),
              u.done(function () {
                for (i in (f || S([e]), w.remove(e, "fxshow"), p))
                  E.style(e, i, p[i]);
              })),
              (l = vt(f ? m[i] : 0, i, u)),
              i in m ||
    ...
    E.fn.extend({
      ...
      hasClass: function (e) {
        for (var t, n = 0, i = " " + e + " "; (t = this[n++]); )
          if (1 === t.nodeType && -1 < (" " + I(j(t)) + " ").indexOf(i))
            return !0;
        return !1;
      },
    });
      ...
      (E.extend(E.event, {
        trigger: function (e, t, n, i) {
          ...
          if (
            ...
            ((e = e[E.expando]
              ? e
              : new E.Event(p, "object" == typeof e && e)).isTrigger = i
              ? 2
              : 3),
            (e.namespace = h.join(".")),
            ...
            if (!i && !c.noBubble && !m(n)) {
              for (
                a = c.delegateType || p, Ct.test(a + p) || (f = f.parentNode);
                f;
                f = f.parentNode
              )
                u.push(f), (r = f);
      ...
      ajax: function (e, t) {
        ...
        function L(e, t, n, i) {
          ...
          p ||
            ...
            w.statusCode(b),
            (b = void 0),
            h && g.trigger(i ? "ajaxSuccess" : "ajaxError", [w, f, i ? o : r]),
            y.fireWith(m, [w, s]),
            h &&
    ...
    Kt =
      ...
      (E.fn.load = function (e, t, n) {
        var i,
          ...
          s = e.indexOf(" ");
        return (
          -1 < s && ((i = I(e.slice(s))), (e = e.slice(0, s))),
          y(t)
            ? ((n = t), (t = void 0))
...
(VL.util = {}),
  ...
  (function (e) {
    ...
    function v(e, t, n) {
      ...
      function l() {
        if (!--a)
          for (var e in ((p[r] = 1), o && o(), h))
            m(e.split("|"), s) && (g(h[e], s), (h[e] = []));
      }
      return (
        setTimeout(function () {
          g(e, function e(t, n) {
      ...
      (v.ready = function (e, t, n) {
        ...
        return (
          ...
          m(e, function (e) {
            ...
            ? t()
            : ((e = e.join("|")), (h[e] = h[e] || []), h[e][d](t), n && n(i)),
          v
        );
      }),
      (v.done = function (e) {
  ...
  (function (e) {
    ...
    var n = Array.prototype.slice,
      ...
      s = {
        ...
        unstick: function (e) {
          return this.each(function () {
            for (var e = d(this), t = -1, n = h.length; 0 < n--; )
              h[n].stickyElement.get(0) === this && (i.call(h, n, 1), (t = n));
            -1 !== t &&
              (e.unwrap(),
              e.css({
                width: "",
      ...
      function p(e, t, n) {
        ...
        if ("undefined" != typeof document) {
          if (1 < arguments.length) {
            "number" == typeof (n = h({ path: "/" }, p.defaults, n)).expires &&
...
customElements.define("lite-youtube", LiteYTEmbed),
  (window.Modernizr = (function (e, d) {
    ...
    function n(e, t, n, i) {
      ...
      if (parseInt(n, 10))
        for (; n--; )
          ((r = d.createElement("div")).id = i ? i[n] : p + (n + 1)),
            s.appendChild(r);
      return (
          ...
          r = function () {
            ...
            return this instanceof r
              ? (((e = function () {}).prototype = i.prototype),
                (e = new e()),
                (t = i.apply(e, o.concat(h.call(arguments)))),
                Object(t) === t ? t : e)
              : i.apply(n, o.concat(h.call(arguments)));
          };
        return r;
      }),
    (l.touch = function () {
        ...
        this.sourceElems.forEach(
          function (e) {
            ...
            (t.url = e.getAttribute("href")),
              (t.mobileUrl = e.mobileurl || t.url),
              (t.width = parseInt(e.width) || (n ? 640 : 960)),
              (t.height = parseInt(e.height) || (9 * t.width) / 16),
              (t.title =
                e.firstElementChild.title ||
              ...
              t.purpose ||
                (t.url.includes("youtube.com/")
                  ...
                  : (t.purpose = "image")),
              "video" == t.purpose &&
                ((t.videoId = e.youtubeid || t.url.split("=")[1]),
                (t.thumbUrl = e.youtubethumb || t.thumbUrl),
                (t.start = e.youtubestart),
                (t.end = e.youtubeend),
                (t.cc = e.youtubecc),
                (t.autoplay = e.youtubeautoplay)),
...
class ImageGalleryController {
  ...
  makeMediaElement(t, n = !0) {
    ...
    if ("image" == i.purpose)
      ...
      "video" == i.purpose &&
      (((o = document.createElement("iframe")).ImageGalleryIndex = t),
...
class ImageGalleryHeroThumbs {
  constructor(e) {
    (this.rootElem = e.rootElem),
      ...
      (this.thumbElems = []);
    var t = parseInt(this.rootElem.count) || 5,
  ...
  constructor() {
    document.querySelectorAll(".video-launcher").forEach(
      function (e) {
        ...
        const n = e.youtubeid ? e : e.querySelector("[data-youtubeid]");
        t &&
          n &&
          (t.addEventListener(
            "click",
...
function vlppCalendarGetBookingLink() {
  var e = location.pathname;
  let t = document.querySelector(".product-info-booking a").href;
  return (
    e.includes("/place/23035130-") &&
      (t =
        "https://tickets.london/gt2/timeslot/warner-bros-studio-tour-london-the-making-of-harry-potter-with-return-transportation-/169"),
    (t = e.includes("/place/22249-")
      ? "https://tickets.london/gt2/timeslot/tower-of-london-tickets/263"
      : t)
  );
}
function vlppCalendarSidebar() {
  $.fx.off = !0;
  const e = vlppCalendarGetBookingLink().slice(22).split("?")[0];
  var t = document.querySelector(".product-booking-box"),
    n =
      (document.querySelector(".product-usps"),
      t && (t.style.position = "static"),
      document.createElement("div"));
  document.querySelector(".product-info-booking").remove(),
    t.after(n),
    (n.innerHTML = '<div id="caltest"></div>'),
    n.classList.add("calbox", "inline"),
    new MutationObserver(vlppCalendarChanged).observe(n, {
      childList: !0,
      subtree: !0,
    }),
    $.getScript(
    ...
    window.addEventListener("resize", vlppCalendarSidebarFit),
    vlppCalendarSidebarFit();
}
function vlppCalendarModal() {
  var e = document.querySelector(".product-info-booking a");
  const t = vlppCalendarGetBookingLink();
  e.addEventListener("click", function (e) {
    vlppCalendarModalOpen(e, t);
  }),
    e.removeAttribute("target"),
    e.removeAttribute("data-ga-link"),
    e.removeAttribute("href");
  var n = {
  ...
  e.setAttribute("title", n.replace("<br>", " ")),
    (e.querySelector("span").innerHTML = "" + n);
}
function vlppCalendarModalOpen(e, t) {
  e.preventDefault(), ($.fx.off = !0);
  e = $(
    "<div class='calmodal'><span tabindex='0' id='cal-focus'></span><div class='calbox modal'><div id='caltest'></div><div id='calclose'></div></div></div>"
  );
  $("body").append(e);
  const n = document.querySelector(".calmodal"),
    i =
      (n.addEventListener("click", function (e) {
        e.target === n && n.remove();
      }),
      window.addEventListener("keyup", vlppCalendarCloseOnEsc),
      n.querySelector("#calclose")),
    o =
      (i.addEventListener("click", function (e) {
        e.target === i && n.remove();
      }),
  ...
  return (
    ...
    window.addEventListener("resize", vlppCalendarModalFit),
    vlppCalendarModalFit(),
    !1
  );
}
function vlppCalendarCloseOnEsc(e) {
  "Escape" == e.key &&
    (document.querySelector(".calmodal").remove(),
    window.removeEventListener("click", vlppCalendarCloseOnEsc));
}
function vlppCalendarSidebarFit() {
  var e,
    t,
    n = document.querySelector("#caltest"),
    i = document.querySelector(".calendar-container");
  i &&
    n &&
    (window.innerWidth < 660
      ? ((t = n.clientWidth / i.clientWidth),
        (e = i.scrollWidth / i.scrollHeight),
        (t = Math.min(t, 1)),
        (i.style.transform = `scale(${t})`),
        (i.style.transformOrigin = "top left"),
        (n.style.height = n.clientWidth / e + "px"))
      : ((i.style.transform = "none"), (n.style.height = "unset")));
}
function vlppCalendarModalFit() {
  var e = document.querySelector(".calbox"),
    t = document.querySelector("#caltest"),
    n = (window.innerWidth - 16) / t.clientWidth,
    t = (window.innerHeight - 16) / t.clientHeight,
    n = Math.min(n, t, 1.3333);
  e.style.transform = `scale(${n})`;
}
function vlppCalendarChanged(e, t) {
  for (const s of e) {
    for (const l of s.removedNodes);
    for (const c of s.addedNodes)
      if (1 == c.nodeType) {
        c.classList.contains("calendar") &&
          (n = document.querySelector("#cal-focus")) &&
          n.focus();
        var n = c.querySelectorAll(".multipleEventButton");
        for (b of n) {
          const link = b.parentElement;
          link.setAttribute("no-mousedown", "true"), vlppAddConvParams(link);
          var i = b.querySelector("p");
          let e = i.innerText;
        ...
        if (o) {
          ...
          r.addEventListener("click", () => {
            d.scrollTo({
              left: d.scrollLeft - 162,
              top: 0,
              behavior: "smooth",
            }),
              vlppCalendarScrolled();
          }),
            ...
            d.addEventListener("scroll", vlppCalendarScrolled),
            vlppCalendarScrolled();
        }
        if ("TABLE" == c.tagName) {
          for (link of c.querySelectorAll(".day.has-event a"))
            link.setAttribute("no-mousedown", "true"), vlppAddConvParams(link);
          const u = c.querySelectorAll(".simple-calendar-has-tooltip");
          for (const p of u)
            p.setAttribute("tabindex", "0"),
              ...
              p.addEventListener("click", function (e) {
                u.forEach((e) => e.classList.remove("selected")),
  ...
  document.querySelector(".product-booking-box #caltest") &&
    vlppCalendarSidebarFit();
}
function vlppAddConvParams(e) {
  var t,
    n,
    i = e.href;
  !i.includes("_conv_v=") &&
    !i.includes("_conv_s=") &&
    ((t = convert.getCookie("_conv_v")),
    (n = convert.getCookie("_conv_s")),
    t || n) &&
    ((t =
      "_conv_v=" + encodeURIComponent(t) + "&_conv_s=" + encodeURIComponent(n)),
    (n = i.includes("?") ? "&" : "?"),
    (e.href = i + n + t));
}
function vlppCalendarScrolled() {
...
"loading" == document.readyState
  ...
  $(window).on("load", function () {
    location.search.includes("calsidebar") && vlppCalendarSidebar(),
      location.search.includes("calmodal") && vlppCalendarModal();
  }),
  "loading" == document.readyState
