(function (w, g) {
  ...
  (function () {
    ...
    (gi.Vg = "4880"),
      ...
      (gi.Ya = "dataLayer"),
      (gi.rn =
        "ChAI8OXmtQYQvoz264Wm4NZCEiQA0wocucPM3iIkCmxguQ5Q/VQrOssebNbdka1ymrL3k52zgQcaAi6X");
    var ki,
      ii = {
        __cl: 1,
        __ecl: 1,
          ...
          try {
            if (b.length > 0) {
              var e = b.shift(),
                ...
                g = e;
              if (
                "SCRIPT" === String(g.nodeName).toUpperCase() &&
                "text/gtmscript" === g.type
              ) {
                var k = g.text || g.textContent || g.innerHTML || "",
                  m = g.getAttribute("data-gtmsrc"),
                  n = g.charset || "";
                m
                  ? Ac(m, f, d, { async: !1, id: e.id, text: k, charset: n }, a)
                  : (((g = H.createElement("script")).async = !1),
                ...
                a.insertBefore(e, null), wH(e, p, f, d)();
    ...
    (Z.securityGroups.d = ["google"]),
      ...
      (function () {
        ...
        (Z.__unsafe_inject_arbitrary_html = function (b) {
